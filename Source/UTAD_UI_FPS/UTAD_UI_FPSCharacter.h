...
class AUTAD_UI_FPSCharacter : public ACharacter
{
	...
	/** Toggle Skill Tree */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Input, meta = (AllowPrivateAccess = "true"))
	class UInputAction* m_pToggleSkillTree;
...
public:
	...
	TSubclassOf<UUserWidget> m_oSkillTreeWidgetClass;

	UUserWidget* m_pSkillTreeWidget;
	...
	void SetSkillPoints(int16 _SkillPoints);
...
protected:
	...
	/** Called for activate the skill tree widget*/
	void ToggleSkillTree();

	bool bCanToggledSkillTree = true;

	APlayerController* m_pPlayerController;

	UPROPERTY(EditAnywhere, Category = "Skill Points")
